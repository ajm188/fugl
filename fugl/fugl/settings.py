"""
Django settings for fugl project.
...
from fugl.credentials import SECRET_KEY
from fugl.credentials import DB_PASSWORD
import os
...
if 'FUGL_PRODUCTION' in os.environ:
    DEBUG = False
else:
    DEBUG = True

ALLOWED_HOSTS = ['fugl.xyz']
...
WSGI_APPLICATION = 'fugl.wsgi.application'
